...
import com.canadianwurbokid.morebiomes.biome.ModdedSaplings;
...
public class ModBlocks {
	...
	public static Block Saplings = new ModdedSaplings().setBlockName("Sapling");
	...
	public static final void init() {
		...
		GameRegistry.registerBlock(Saplings, ItemSaplingBlocks.class, Saplings.getUnlocalizedName().substring(0));
