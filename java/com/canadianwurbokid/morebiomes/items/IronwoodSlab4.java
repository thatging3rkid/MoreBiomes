...
public class IronwoodSlab4 extends ItemBlock
{
    ...
    public IronwoodSlab4(Block block)
    {
	    super(block);
	    this.field_150949_c = ModBlocks.IronwoodSlab;
	    this.field_150947_d = ModBlocks.DoubleIronwoodSlab;
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
	    ...
	    else
	    {
		    ...
		    if ((par7 == 1 && !flag || par7 == 0 && flag) && block == this.field_150949_c && j1 == par1ItemStack.getItemDamage())
		    {
			    ...
			    //if (par3World.checkNoEntityCollision(Blocks.double_stone_slab.getCollisionBoundingBoxFromPool(par3World, par4, par5, par6)) && par3World.setBlock(par4, par5, par6, Blocks.double_stone_slab, j1, 3))
			    {
